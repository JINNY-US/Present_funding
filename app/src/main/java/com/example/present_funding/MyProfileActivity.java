            ...
            public void onClick(View v) {
                if(!editTextTextPersonName4.getText().toString().equals("") && !setting_pass.getText().toString().equals("") && !setting_pass_check.getText().toString().equals("")) {
                    ...
                    if(password.equals(password_check)) {
                            ...
                            user.updatePassword(password).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(MyProfileActivity.this, "수정에 성공했습니다.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                        }
                        ...
                        Toast.makeText(MyProfileActivity.this, "비밀번호를 다시 확인해주세요.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(MyProfileActivity.this, "작성하지 않은 항목이 있습니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
